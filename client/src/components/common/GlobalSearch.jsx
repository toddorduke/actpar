      ...
      <div className="gs-panel">
        <div className="gs-input-row">
          ...
          <input
            ref={inputRef}
            className="gs-input"
            placeholder="Search people by name or alter ego…"
            value={query}
        ...
        <div className="gs-results">
          ...
          {!loading && query.trim() && results.length === 0 && (
            <p className="gs-status">No one found for "{query}"</p>
          )}

          {!loading && !query.trim() && (
            <p className="gs-hint">Start typing to find anyone on ActPar</p>
          )}
